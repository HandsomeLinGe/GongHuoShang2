...
public abstract class AbsMoreBaseAdapter<T> extends BaseAdapter{
    ...
    public class ViewHolder{
        ...
        public  ViewHolder bindImageView(int id, String path){
            ImageView iv = (ImageView) this.getView(id);
            Picasso.with(context).load(path).noFade().placeholder(android.R.drawable.ic_dialog_alert)
                    .error(android.R.drawable.ic_delete).into(iv);
            return this;
        }
    }
